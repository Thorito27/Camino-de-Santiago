...
const ETAPAS = [
{
  ...
  puntos:[
    ...
    {nombre:"Iglesia de Santiago de Barbadelo", lat:42.765180, lon:-7.450550, km:4.36, ele:543, kmGuia:4.2, tipo:'iglesia', sellar:true, horario:"8:30-12:30", fiable:true, ficha:"Románica del s. XII. Primer punto de interés. Google recoge 8:00-12:00; la guía dice 8:30-12:30. Sin verificar.", desviacion_m:14},
    {nombre:"Barbadelo", lat:42.765180, lon:-7.450550, km:4.36, ele:543, kmGuia:4.4, tipo:'taxi', fiable:true, ficha:"Punto de escape. Taxis: Alberto 649850117, David 669087722. Tramo Sarria-Barbadelo: dificultad ALTA según la guía.", desviacion_m:274},
    {nombre:"Rente", lat:42.769370, lon:-7.462590, km:5.88, ele:590, kmGuia:5.6, tipo:'paso', fiable:true, desviacion_m:85},
    {nombre:"Mercado da Serra", lat:42.773060, lon:-7.468920, km:6.69, ele:617, kmGuia:6.4, tipo:'comida', fiable:true, ficha:"Taberna da Serra. Punto de desayuno propuesto en la guía.", desviacion_m:88},
    ...
    {nombre:"Cortiñas", lat:42.778910, lon:-7.499460, km:10.49, ele:630, kmGuia:9.6, tipo:'paso', fiable:true, desviacion_m:39},
    {nombre:"Brea", lat:42.778840, lon:-7.508440, km:11.44, ele:605, kmGuia:11.1, tipo:'cultura', fiable:true, ficha:"Entre Brea y Morgade está el mojón clásico del km 100.", desviacion_m:137},
    {nombre:"Morgade", lat:42.782190, lon:-7.521230, km:12.72, ele:633, kmGuia:11.9, tipo:'comida', fiable:true, ficha:"Bar Casa Morgade. Abre 7:30-21:30.", desviacion_m:27},
    {nombre:"Ferreiros", lat:42.783610, lon:-7.533360, km:14.14, ele:643, kmGuia:13.3, tipo:'taxi', fiable:true, ficha:"Punto de escape principal. Desde Casa Cruceiro (LU-633) o Iglesia de San Salvador (LU-P-5707). Veña Café Bar: miles de botellines firmados.", desviacion_m:63},
    {nombre:"Mirallos", lat:42.784190, lon:-7.538790, km:14.61, ele:620, kmGuia:13.9, tipo:'iglesia', fiable:true, ficha:"Iglesia de Santa María, románica s. XII-XIII. Suele estar cerrada, a 300 m de la salida del pueblo.", desviacion_m:92},
    {nombre:"A Pena", lat:42.784930, lon:-7.546870, km:15.41, ele:624, kmGuia:14.5, tipo:'cultura', fiable:true, ficha:"Cerca está el mojón del km 100 oficial actual.", desviacion_m:230},
    ...
    {nombre:"Moimentos", lat:42.790390, lon:-7.571610, km:18.00, ele:509, kmGuia:16.6, tipo:'paso', fiable:true, desviacion_m:222},
    {nombre:"Mercadoiro", lat:42.791070, lon:-7.576230, km:18.43, ele:528, kmGuia:17.3, tipo:'paso', fiable:true, desviacion_m:224},
    {nombre:"Moutras", lat:42.794360, lon:-7.590000, km:19.77, ele:455, kmGuia:19, tipo:'paso', fiable:true, desviacion_m:40},
    {nombre:"Parrocha", lat:42.795180, lon:-7.596970, km:20.38, ele:424, kmGuia:19.7, tipo:'paso', fiable:true, desviacion_m:20},
    {nombre:"Vilachá", lat:42.795580, lon:-7.603500, km:20.95, ele:396, kmGuia:21, tipo:'comida', fiable:true, ficha:"Los Andantes. Última parada antes de la bajada final.", desviacion_m:25},
    {nombre:"Iglesia-fortaleza de San Nicolás", lat:42.807320, lon:-7.615850, km:23.46, ele:344, kmGuia:22.3, tipo:'iglesia', sellar:true, horario:"10:00-20:00", fiable:true, ficha:"S. XII, orden de San Juan de Jerusalén. Trasladada piedra a piedra al construirse el embalse.", desviacion_m:49},
    {nombre:"Portomarín", lat:42.806670, lon:-7.616670, km:0.00, ele:381, kmGuia:22.4, tipo:'fin', fiable:true, desviacion_m:12}
  ],
  timing:[
...
},
{
  ...
  puntos:[
    ...
    {nombre:"Gonzar", lat:42.826060, lon:-7.695830, km:8.81, ele:532, kmGuia:8.2, tipo:'taxi', fiable:true, ficha:"Iglesia de Santa María. Punto de escape. Bar/Albergue de Gonzar, Hostería de Gonzar. Fin del tramo más duro del día.", desviacion_m:121},
    ...
    {nombre:"Hospital da Cruz", lat:42.840540, lon:-7.733860, km:12.97, ele:656, kmGuia:12, tipo:'comida', fiable:true, ficha:"Taberna do Camiño — tortillas de patata famosas.", desviacion_m:19},
    {nombre:"Ventas de Narón", lat:42.844240, lon:-7.748800, km:14.62, ele:688, kmGuia:13.5, tipo:'iglesia', sellar:true, fiable:true, ficha:"Ermita de la Magdalena. SELLAR si está abierta, pero abre poco tiempo. Albergue.", desviacion_m:15},
    {nombre:"Sierra de Ligonde", lat:42.850060, lon:-7.762060, km:16.17, ele:691, kmGuia:15, tipo:'mirador', fiable:true, ficha:"Punto más alto de toda la ruta: 722 m.", desviacion_m:8},
    {nombre:"Cruceiro de Lameiros", lat:42.855300, lon:-7.777380, km:17.76, ele:616, kmGuia:16, tipo:'cultura', fiable:true, ficha:"Uno de los más famosos del camino, doble cara, mucha simbología. FECHA EN DISPUTA: la guía dice 1674 en una diapositiva y 1670 en otra. Google recoge 1670.", desviacion_m:16},
    {nombre:"Ligonde", lat:42.858850, lon:-7.779650, km:18.24, ele:614, kmGuia:16.5, tipo:'taxi', fiable:true, ficha:"Punto de escape. Bar Restaurante Ligonde, Casa Mariluz, Trisquel. Cementerio de peregrinos.", desviacion_m:39},
    ...
    {nombre:"A Brea", lat:42.918500, lon:-8.307950, km:13.98, ele:366, kmGuia:22.2, tipo:'paso', fiable:false, ajustado:397, desviacion_m:0},
    {nombre:"Avenostre", lat:42.873420, lon:-7.857590, km:26.47, ele:595, kmGuia:23.4, tipo:'paso', fiable:true, desviacion_m:204},
    {nombre:"Palas de Rei", lat:42.873330, lon:-7.868930, km:0.25, ele:569, kmGuia:25, tipo:'fin', fiable:true, desviacion_m:24}
  ],
  timing:[
...
},
{
  ...
  puntos:[
    ...
    {nombre:"San Xulián do Camiño", lat:42.875510, lon:-7.907980, km:4.27, ele:454, kmGuia:3.5, tipo:'comida', fiable:true, ficha:"The Essential Coffee Home — muchas tostadas, tarta de Santiago. Iglesia románica s. XII y cementerio. Coordenada aproximada.", desviacion_m:204},
    {nombre:"Pontecampaña", lat:42.879820, lon:-7.918430, km:5.31, ele:435, kmGuia:4.7, tipo:'comida', fiable:true, ficha:"Mesón A Pontecampaña.", desviacion_m:157},
    {nombre:"Casanova", lat:42.880790, lon:-7.934540, km:6.75, ele:491, kmGuia:6, tipo:'paso', fiable:true, desviacion_m:140},
    ...
    {nombre:"O Leboreiro", lat:42.890130, lon:-7.968940, km:10.21, ele:439, kmGuia:9.2, tipo:'taxi', fiable:true, ficha:"Aldea medieval. Cabazo (granero-canasta para maíz). Iglesia de Santa María, románico de transición. Punto de escape: taxi desde la iglesia. Taberna de Leboreiro.", desviacion_m:260},
    {nombre:"Parque empresarial", lat:42.900280, lon:-7.986080, km:12.15, ele:460, kmGuia:11.2, tipo:'paso', fiable:true, desviacion_m:93},
    {nombre:"Furelos", lat:42.909050, lon:-7.999120, km:13.81, ele:408, kmGuia:13, tipo:'cultura', fiable:true, ficha:"Puente medieval. Sitio agradable junto al río.", desviacion_m:49},
    {nombre:"Melide", lat:42.911170, lon:-8.024410, km:0.89, ele:434, kmGuia:14.5, tipo:'fin', fiable:false, ajustado:620, desviacion_m:0}
  ],
  timing:[
...
},
{
  ...
  puntos:[
    ...
    {nombre:"Santa María de Melide", lat:42.914850, lon:-8.040630, km:2.38, ele:428, kmGuia:1.8, tipo:'iglesia', fiable:true, ficha:"Monumento Nacional s. XII, a las afueras de Melide. SELLAR.", desviacion_m:54},
    {nombre:"Raido", lat:42.915800, lon:-8.055060, km:3.88, ele:463, kmGuia:3.2, tipo:'paso', fiable:true, desviacion_m:23},
    {nombre:"Parabispo", lat:42.917050, lon:-8.064210, km:4.70, ele:427, kmGuia:4, tipo:'paso', fiable:true, desviacion_m:65},
    {nombre:"Boente", lat:42.916290, lon:-8.078020, km:5.99, ele:396, kmGuia:5.8, tipo:'iglesia', horario:"7:30-14:30", fiable:true, ficha:"Iglesia de Santiago. Cafetería El Alemán, Panadería A Castellana, Albergue Boente enfrente de la iglesia.", desviacion_m:69},
    ...
    {nombre:"Arzúa", lat:42.926240, lon:-8.163430, km:0.00, ele:385, kmGuia:14.1, tipo:'fin', fiable:true, desviacion_m:240}
  ],
  timing:[
...
},
{
  ...
  puntos:[
    ...
    {nombre:"As Barrosas", lat:42.926990, lon:-8.171690, km:0.72, ele:347, kmGuia:0.9, tipo:'paso', fiable:true, desviacion_m:115},
    {nombre:"Preguntoño", lat:42.924120, lon:-8.184350, km:1.98, ele:334, kmGuia:2.2, tipo:'paso', fiable:true, desviacion_m:347},
    {nombre:"A Peroxa", lat:42.927030, lon:-8.199490, km:3.70, ele:360, kmGuia:3.3, tipo:'paso', fiable:true, desviacion_m:122},
    {nombre:"Taberna Vella", lat:42.925900, lon:-8.221760, km:5.73, ele:385, kmGuia:5.2, tipo:'paso', fiable:true, desviacion_m:175},
    ...
    {nombre:"A Calle", lat:42.922220, lon:-8.256910, km:9.30, ele:377, kmGuia:7.8, tipo:'paso', fiable:true, desviacion_m:114},
    ...
    {nombre:"Ras", lat:42.918860, lon:-8.301090, km:13.36, ele:376, kmGuia:13.1, tipo:'paso', fiable:true, desviacion_m:17},
    {nombre:"A Brea", lat:42.918500, lon:-8.308000, km:13.98, ele:366, kmGuia:13.7, tipo:'paso', fiable:true},
    {nombre:"Rabiña", lat:42.917010, lon:-8.315430, km:14.71, ele:380, kmGuia:15, tipo:'paso', fiable:true, desviacion_m:119},
    ...
    {nombre:"O Pedrouzo", lat:42.904600, lon:-8.362400, km:0.00, ele:295, kmGuia:19.1, tipo:'fin', fiable:false, ajustado:589, desviacion_m:0}
  ],
  timing:[
...
},
{
  ...
  puntos:[
    ...
    {nombre:"San Antón", lat:42.904020, lon:-8.376340, km:1.60, ele:286, kmGuia:1.3, tipo:'paso', fiable:true, desviacion_m:250},
    ...
    {nombre:"Lavacolla", lat:42.899240, lon:-8.444820, km:9.65, ele:299, kmGuia:10, tipo:'taxi', fiable:true, ficha:"Lugar donde los peregrinos se despojaban de sus ropas sucias. Punto de encuentro para hacer juntos los últimos km. También se puede venir en taxi directamente hasta aquí.", desviacion_m:25},
    {nombre:"Villamaior", lat:42.890580, lon:-8.460070, km:11.74, ele:382, kmGuia:11.5, tipo:'paso', fiable:true, desviacion_m:269},
    {nombre:"TV Galicia", lat:42.890620, lon:-8.476180, km:13.30, ele:378, kmGuia:13.3, tipo:'paso', fiable:true, desviacion_m:347},
    {nombre:"RTVE", lat:42.890750, lon:-8.485910, km:14.10, ele:372, kmGuia:14.1, tipo:'paso', fiable:false, ajustado:442, desviacion_m:0},
    {nombre:"Monte do Gozo", lat:42.887730, lon:-8.499980, km:16.25, ele:326, kmGuia:15.4, tipo:'mirador', fiable:true, ficha:"El mirador más importante de la ruta: primera vista de las torres de la catedral. Cafetería en el complejo. Grupo escultórico de los dos peregrinos.", desviacion_m:245},
    {nombre:"San Marcos", lat:42.886170, lon:-8.510460, km:17.19, ele:281, kmGuia:15.8, tipo:'paso', fiable:true, desviacion_m:135},
    ...
    {nombre:"Catedral de Santiago", lat:42.881140, lon:-8.544480, km:20.43, ele:275, kmGuia:20, tipo:'fin', fiable:true, ficha:"Entrada por la Puerta del Camino, Plaza de Cervantes, Plaza del Obradoiro. Misa del peregrino 19:30. Abierta 7:00-21:00.", desviacion_m:51}
  ],
  timing:[
